...
import { Leaf, Cpu, WifiOff, ShieldCheck, Volume2, Globe, Users, Target } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4">
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold text-slate-900 tracking-tight">
            Democratizing <span className="text-emerald-700">Offline AI</span> For Farmers
          </h1>
          <p className="text-slate-600 text-base sm:text-lg">
            Empowering smallholder farmers to diagnose crop leaf diseases anywhere on Earth—no internet, no expensive hardware, no language barriers.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-8 rounded-3xl border border-emerald-100 shadow-xs space-y-3">
            ...
            <p className="text-sm text-slate-600 leading-relaxed">
              Eliminate crop yield loss caused by late disease detection by delivering high-speed edge AI diagnostic software straight to farmers' mobile browsers.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-3xl border border-emerald-100 shadow-xs space-y-3">
            ...
            <h3 className="text-xl font-bold text-slate-900">Zero Internet First</h3>
            <p className="text-sm text-slate-600 leading-relaxed">
              Designed explicitly for remote rural fields. Once loaded, AgriVision runs entirely offline using WebAssembly and lightweight neural weights.
            </p>
          </div>
        ...
        <div className="bg-white p-8 sm:p-12 rounded-3xl border border-emerald-100 shadow-lg grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          <div className="lg:col-span-6 space-y-4">
            ...
            <p className="text-sm text-slate-600 leading-relaxed">
              Existing digital farming solutions rely heavily on cloud servers and persistent 4G connectivity—services that are absent in deep agricultural heartlands. AgriVision solves this bottleneck by bringing the AI engine into the browser on the farmer’s device.
            </p>
            <div className="pt-4">
              <button
